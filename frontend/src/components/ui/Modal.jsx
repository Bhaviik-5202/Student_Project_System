...
const Modal = ({
  ...
  return (
    <div className='fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 overflow-y-auto'>
      ...
      {/* Modal Dialog */}
      <div
        className={`relative w-full ${maxWidth} max-h-[90vh] flex flex-col bg-white dark:bg-slate-900 rounded-xl sm:rounded-2xl shadow-2xl border border-slate-200 dark:border-slate-800 z-10 overflow-hidden transform transition-all duration-300 animate-scaleUp`}
      >
        {/* Header */}
        {(title || showClose) && (
