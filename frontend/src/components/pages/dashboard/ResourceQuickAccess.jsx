    ...
    <div className='rounded-xl border border-slate-200 bg-white p-6 shadow-sm dark:border-slate-700 dark:bg-slate-800'>
      ...
      <div className='grid grid-cols-2 gap-4 sm:grid-cols-3'>
        {resources.map((resource, index) => (
          <button
            ...
            className='group flex flex-col items-center justify-center rounded-xl border border-slate-200 p-4 transition-all duration-200 hover:border-blue-300 hover:shadow-md dark:border-slate-700 dark:hover:border-blue-500'
          >
            <div
      ...
      <div className='mt-6 border-t border-slate-200 pt-6 dark:border-slate-700'>
        <button
          ...
          className='w-full rounded-lg border-2 border-dashed border-slate-300 py-3 text-slate-600 transition-colors hover:border-blue-400 hover:bg-blue-50 hover:text-blue-600 dark:border-slate-600 dark:text-slate-400 dark:hover:border-blue-500 dark:hover:bg-blue-900/30 dark:hover:text-blue-400'
        >
