  ...
  return (
    <div className="p-4 md:p-6 space-y-6 animate-fade-in">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-6">
        <div>
          <h1 className="text-xl font-bold text-gray-900 dark:text-white">Progress Analytics</h1>
          <p className="text-sm text-gray-500 dark:text-gray-400 mt-1 font-medium">Monitor project progress and completion rates</p>
        </div>
      </div>
              ...
              <div>
                ...
                <div className="space-y-2">
                  {[
                    {
                      label: "On Track",
                      count: projects.filter((p) => p.timeline === "On Track").length,
                      color: "bg-emerald-500",
                    },
                    {
                      label: "Slightly Behind",
                      count: projects.filter((p) => p.timeline === "Slightly Behind").length,
                      color: "bg-amber-500",
                    },
                    {
                      label: "Behind Schedule",
                      count: projects.filter((p) => p.timeline === "Behind Schedule").length,
                      color: "bg-rose-500",
                    },
                    {
                      label: "Ahead",
                      count: projects.filter((p) => p.timeline === "Ahead").length,
                      color: "bg-blue-500",
                    },
                  ].map((status, index) => (
