    ...
    >
      <div className='w-full max-w-sm rounded-2xl bg-white p-6 shadow-2xl dark:bg-slate-800'>
        ...
        <div className='flex justify-end gap-3'>
          <button
            onClick={onClose}
            className='rounded-xl border border-slate-200 bg-white px-4 py-2.5 text-sm font-semibold text-slate-700 hover:bg-slate-50 dark:border-slate-600 dark:bg-slate-700 dark:text-slate-200'
          >
            Cancel
          </button>
          <button
...
const MilestoneTracker = memo(() => {
  ...
  return (
    <div className='animate-fade-in space-y-6 p-4 md:p-6'>
      ...
      {/* Content */}
      {loading ? (
        <div className='flex flex-col items-center gap-3 rounded-2xl border border-gray-200 bg-white p-20 text-center shadow-sm dark:border-slate-700 dark:bg-slate-800'>
        ...
        <div className='flex flex-col items-center gap-4 rounded-2xl border border-dashed border-gray-200 bg-white p-16 text-center shadow-sm dark:border-slate-700 dark:bg-slate-800'>
        ...
        <div className='space-y-4'>
          {milestones.map((milestone) => (
            <div
              ...
              className={`group relative rounded-2xl border bg-white p-6 shadow-sm transition-all hover:shadow-md dark:bg-slate-800 ${
                milestone.completed
              ...
              <div className='ml-2 flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between'>
                ...
                <div className='flex shrink-0 items-center gap-2'>
                  ...
                  <button
                    ...
                    className='rounded-xl border border-slate-200 bg-white px-3 py-2 text-xs font-semibold text-slate-600 hover:bg-slate-50 dark:border-slate-600 dark:bg-slate-700 dark:text-slate-300'
                  >
                    View Project
                  </button>
                  ...
                  {isStaff && (
                    <>
                      ...
                      <button
                        ...
                        className={`rounded-xl p-2 transition-colors ${
                          milestone.completed
                            ...
                            : 'border border-slate-200 bg-white text-slate-400 hover:border-emerald-300 hover:text-emerald-500 dark:border-slate-600 dark:bg-slate-700'
                        }`}
                      >
                      ...
                      <button
                        ...
                        className='rounded-xl border border-slate-200 bg-white p-2 text-slate-500 hover:border-indigo-300 hover:text-indigo-600 dark:border-slate-600 dark:bg-slate-700 dark:text-slate-400'
                      >
                        <Edit2 size={15} />
                      </button>
                      ...
                      <button
                        ...
                        className='rounded-xl border border-slate-200 bg-white p-2 text-slate-500 hover:border-rose-300 hover:text-rose-600 dark:border-slate-600 dark:bg-slate-700 dark:text-slate-400'
                      >
                        <Trash2 size={15} />
                      </button>
                    </>
