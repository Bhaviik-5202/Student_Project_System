        ...
        <div className="mb-8 flex flex-col md:flex-row justify-between items-start md:items-end gap-6">
          <div className="flex-1">
            <button
              ...
              className="text-indigo-600 dark:text-indigo-400 hover:text-indigo-800 dark:hover:text-indigo-200 flex items-center mb-6 text-xs font-black tracking-[0.2em]"
            >
              ← Back to Overview
            </button>
            <div className="flex items-center gap-4 mb-2">
              ...
              <div className="px-3 py-1 bg-indigo-600 text-white rounded-lg text-[10px] font-black tracking-widest h-fit">Strategic</div>
            </div>
          ...
          <div className="bg-white dark:bg-slate-800 p-4 rounded-2xl border border-gray-100 dark:border-slate-700 shadow-sm flex items-center gap-4">
             <div className="flex flex-col">
                <span className="text-[10px] font-black text-gray-400 tracking-widest">Active Focus</span>
                <select 
                  value={selectedProjectId}
                  onChange={handleProjectChange}
                  className="bg-transparent border-none text-xs font-black text-indigo-600 dark:text-indigo-400 focus:ring-0 p-0 cursor-pointer tracking-tighter"
                >
        ...
        {loading ? (
          <div className="p-20 text-center flex flex-col items-center">
            <div className="w-12 h-12 border-4 border-indigo-600 border-t-transparent rounded-full animate-spin mb-4"></div>
             <span className="text-xs font-black text-gray-400 tracking-widest">Compiling Strategy...</span>
          </div>
        ) : !projectData ? (
           <div className="p-20 text-center bg-white dark:bg-slate-800 rounded-3xl border border-dashed border-slate-200 dark:border-slate-700">
            <h3 className="text-xl font-black text-slate-900 dark:text-white mb-2 italic tracking-tight">No Strategic Data</h3>
          ...
          <div className="animate-in fade-in slide-in-from-bottom-4 duration-700">
                        ...
                        <div className="mb-6">
                          <div className="flex justify-between items-start gap-4">
                            <h3 className="text-xl font-black text-slate-900 dark:text-white tracking-tighter leading-tight italic">
                             ...
                             <span className="px-3 py-1 bg-white/50 dark:bg-slate-900/50 text-[10px] font-black tracking-widest rounded-lg border border-gray-50 dark:border-slate-700">
                               {phase.quarter}
                             </span>
                          </div>
                           <div className={`text-[10px] font-black mt-3 tracking-[0.2em] px-2 py-0.5 rounded w-fit inline-block ${statusStyles[phase.status].text || 'bg-gray-100 text-gray-500'}`}>
            ...
            <div className="bg-white dark:bg-slate-800 p-8 rounded-3xl border border-gray-100 dark:border-slate-700 shadow-sm flex flex-col md:flex-row items-center justify-between gap-6">
              <div className="flex flex-col">
                 <h4 className="text-xs font-black text-slate-900 dark:text-white tracking-widest mb-1">
                   Strategic Legend
                 </h4>
              ...
              <div className="flex flex-wrap items-center gap-8">
                <div className="flex items-center gap-3">
                  <div className="w-3 h-3 bg-emerald-500 rounded-full shadow-lg shadow-emerald-500/30"></div>
                   <span className="text-[10px] font-black text-slate-500 dark:text-slate-400 tracking-[0.1em]">Validated</span>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-3 h-3 bg-indigo-500 rounded-full shadow-lg shadow-indigo-500/30 animate-pulse"></div>
                   <span className="text-[10px] font-black text-slate-500 dark:text-slate-400 tracking-[0.1em]">In Focus</span>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-3 h-3 bg-slate-300 dark:bg-slate-600 rounded-full"></div>
                   <span className="text-[10px] font-black text-slate-500 dark:text-slate-400 tracking-[0.1em]">Pipeline</span>
                </div>
              </div>
            </div>
          </div>
