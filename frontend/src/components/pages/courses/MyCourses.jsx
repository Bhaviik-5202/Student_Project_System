    ...
    <div className='course-page animate-fade-in'>
        ...
        <div className='flex items-center gap-5'>
          <div>
            ...
            <p className='mt-1 text-sm text-gray-500 dark:text-gray-400'>
              Track your academic progress and enrolled modules
            </p>
          </div>
        </div>
        <button
      ...
      {courses.length === 0 ? (
        ...
        >
          ...
          <p
            style={{ color: 'var(--course-text-muted)', marginBottom: '32px' }}
          >
          ...
          >
            Start Registration{' '}
            <ArrowRight className='course-icon-md course-ml-2' />
          </button>
        </div>
      ) : (
            ...
            return (
              ...
              >
                ...
                >
                  ...
                  <button
                    onClick={() =>
                      navigate(`/courses/${course.id || course._id}/materials`)
                    }
                    className='course-btn course-btn-primary'
                    style={{ fontSize: '12px' }}
                  >
