...
const CourseRegistration = memo(() => {
  ...
  const handleRegister = async () => {
    ...
    try {
      ...
      if (failCount > 0) {
        toast.error(
          `Failed to register for ${failCount} course(s): ${lastError}`
        );
      }
    } finally {
                ...
                return (
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        <CreditCard className='course-icon-sm' />{' '}
                        {course.credits} Cr
                      </div>
                      <div
                        style={{
            ...
            >
              ...
              >
                ...
                <span
                  style={{
                    fontWeight: '800',
                    color: currentCredits > maxCredits ? '#ef4444' : 'inherit',
                  }}
                >
                  {currentCredits} / {maxCredits}
                </span>
              ...
              {currentCredits > maxCredits && (
                <div className='flex items-center gap-2 rounded-lg bg-red-50 p-2 text-[11px] text-red-800 dark:bg-red-900/30 dark:text-red-300'>
                  <AlertCircle className='course-icon-sm' /> Credit limit
                  reached.
                </div>
              )}
              ...
              >
                {registering ? (
                  <div
                    ...
                    style={{ width: '30%', height: '4px', margin: '0 auto' }}
                  ></div>
                ) : (
                  <>
                    Confirm Enrollment{' '}
                    <ArrowRight className='course-icon-sm course-ml-2' />
                  </>
                )}
              </button>
            </div>
