      ...
      <div className='course-details-grid'>
        <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
          <div className='course-card-simple'>
            ...
            <div style={{ padding: '0' }}>
              ...
              >
                {course.description ||
                  'This comprehensive module covers the fundamental and advanced principles of the subject, providing students with both theoretical knowledge and practical applications.'}
              </p>
          ...
          <div className='course-card-simple'>
            <div className='course-card-header'>
              ...
              >
                Full Roadmap{' '}
                <ArrowRight className='course-icon-sm course-ml-1' />
              </button>
            </div>
                  ...
                  course.syllabus.slice(0, 3).map((topic, index) => (
                    <div key={index} className='course-curriculum-item'>
                      ...
                      <div>
                        ...
                        >
                          {topic.description ||
                            'Core concepts and specialized case studies.'}
                        </p>
                      </div>
                    </div>
                  ))
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
          ...
          <div className='course-promo-banner'>
            ...
            <p
              style={{ fontSize: '14px', opacity: '0.9', marginBottom: '24px' }}
            >
          ...
          <div className='course-card-simple'>
            ...
            <div className='course-card-body'>
              ...
              >
                Access course materials, readings, and repository.
              </p>
              <button
