  ...
  if (loading) {
    return (
      <div className='assignment-page flex flex-col items-center justify-center'>
        ...
        <p className='assignment-subtitle mt-4'>
          Initializing assignment registry...
        </p>
      </div>
    );
  }
      ...
      <div className='assignment-container' style={{ maxWidth: '900px' }}>
        <div className='assignment-header'>
          <div>
            ...
            <p className='assignment-subtitle'>
              Set up a new academic task for your students
            </p>
          </div>
          <button
            onClick={() => navigate(-1)}
        ...
        <div className='assignment-card'>
          <form onSubmit={handleSubmit} className='space-y-8'>
                  ...
                  <div className='flex flex-col items-center gap-3'>
                    ...
                    <div>
                      ...
                      <p className='mt-1 text-xs font-bold uppercase tracking-widest text-gray-400'>
                        Documents, ZIPs, or reference materials
                      </p>
                    </div>
                  </div>
                  <input
            ...
            <div className='flex flex-col gap-4 border-t border-gray-100 pt-8 dark:border-slate-800 sm:flex-row'>
              <button
                type='button'
                onClick={() => navigate(-1)}
