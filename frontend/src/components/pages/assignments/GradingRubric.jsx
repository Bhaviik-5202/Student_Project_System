...
const GradingRubric = memo(() => {
  ...
  const addCriterion = useCallback(() => {
    setRubric((prev) => {
      const newId =
        prev.criteria.length > 0
          ? Math.max(...prev.criteria.map((c) => c.id)) + 1
          : Date.now();
      return {
        ...prev,
        criteria: [
    ...
    <div className='assignment-page'>
      <div className='assignment-container'>
          ...
          >
            <div>
              ...
              <p className='assignment-subtitle'>
                Define assessment criteria and point weights
              </p>
            </div>
        ...
        <div className='assignment-card'>
          ...
          >
            <h3 className='assignment-detail-title' style={{ margin: 0 }}>
              Evaluation Criteria
            </h3>
            <button
          ...
          >
            {rubric.criteria.length === 0 ? (
              ...
              >
                <p className='assignment-subtitle'>
                  No criteria added yet. Add one to start building your rubric.
                </p>
              </div>
            ) : (
              rubric.criteria.map((criterion) => (
                <div
                  ...
                  style={{
                    padding: '16px',
                    backgroundColor: 'var(--assignment-bg-light)',
                  }}
                >
                  <div
                    className='assignment-grid assignment-grid-2'
                  ...
                  >
                    ...
                    >
                      <div
                        className='assignment-form-group'
                        style={{ margin: 0 }}
                      >
                        <label
          ...
          <div
            ...
            style={{
              marginTop: '32px',
              border: '1px solid var(--assignment-primary)',
              backgroundColor: 'var(--assignment-bg-light)',
            }}
          >
            <div
            ...
            >
              <div>
                ...
                <p className='assignment-subtitle' style={{ fontSize: '12px' }}>
                  Calculated sum of all criteria point values
                </p>
              </div>
              <p
                style={{
