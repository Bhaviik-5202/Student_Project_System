  ...
  if (loading) {
    return (
      <div className='assignment-page flex flex-col items-center justify-center'>
        <p className='assignment-subtitle animate-pulse italic'>
    ...
    return (
      <div className='assignment-page'>
        <div className='assignment-container' style={{ maxWidth: '600px' }}>
          <div
            className='assignment-card text-center'
            style={{ borderColor: 'var(--color-error)' }}
          >
            <h2 className='mb-2 font-bold text-red-500'>Error</h2>
        ...
        <div className='grid grid-cols-1 gap-8 lg:grid-cols-3'>
          <div className='space-y-8 lg:col-span-2'>
            <div className='assignment-card'>
              <div className='assignment-card-header flex items-start justify-between'>
              ...
              <div className='space-y-8'>
                ...
                {assignment.instructions && (
                  <div className='assignment-detail-section'>
                    <h3 className='assignment-detail-title'>
                      Targeted Instructions
                    </h3>
                    <div className='assignment-detail-content border-indigo-100/50 bg-indigo-50/40 italic dark:border-indigo-800/20 dark:bg-indigo-900/10'>
                      {assignment.instructions}
                    </div>
                  </div>
                )}
            ...
            <div className='flex flex-col gap-4 sm:flex-row'>
              <button
                ...
                className='assignment-btn assignment-btn-primary h-12 flex-1'
              >
                Submit Assignment
              </button>
              <button
                onClick={() => navigate('/assignments/history')}
                className='assignment-btn assignment-btn-secondary h-12 flex-1'
              >
          ...
          <div className='space-y-8'>
            ...
            <div className='assignment-card'>
              ...
              <div className='space-y-4'>
                <div className='rounded-xl border border-gray-100 bg-gray-50/50 p-4 dark:border-slate-800 dark:bg-slate-900/50'>
                ...
                <div className='space-y-3'>
                  {assignment.attachments.map((filePath, index) => {
                    ...
                    return (
                      <div
                        key={index}
                        className='assignment-file-item group border border-transparent transition-all hover:border-indigo-300'
                      >
                        <div className='flex items-center gap-3'>
                          ...
                          <span className='max-w-[120px] truncate text-xs font-bold text-gray-700 dark:text-gray-300'>
                            {fileName}
                          </span>
                        </div>
                        <button className='assignment-btn-text rounded bg-indigo-50 px-2 py-1 text-[10px] uppercase tracking-widest dark:bg-indigo-900/20'>
                          Get
                        </button>
                      </div>
                    );
