...
import { 
  Home, FolderKanban, GraduationCap, Calendar, 
  FolderOpen, Settings, BarChart2, HelpCircle,
  Plus, Search, Play, FileText, Upload, Download,
  Check, X, Trash2, Edit2, Info, History,
