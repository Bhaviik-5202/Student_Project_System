        ...
        <div className="w-full px-4 lg:px-6">
          <div className="flex items-center justify-between h-16 gap-4">
            ...
            <div className="flex items-center gap-3 flex-shrink-0">
              ...
              >
                <Icon name={isMobileMenuOpen ? "xmark" : "bars"} size="text-xl" />
              </button>
              ...
              >
                ...
                <span className="font-bold text-gray-900 dark:text-white text-sm">SPS</span>
              </Link>
            </div>
                ...
                <Dropdown isOpen={showQuickAdd} className="w-60">
                  ...
                  <div className="py-1">
                    {quickAddActions.map((action, index) => (
                      ...
                      >
                        <div className={`flex-shrink-0 w-9 h-9 rounded-xl flex items-center justify-center ${action.bgColor} mr-3 group-hover:scale-105 transition-transform`}>
            ...
            <div className="p-4 sm:p-5">
              ...
              <div className="mt-5">
                ...
                <div className="flex flex-wrap gap-2">
                  {["Projects", "Students", "Meetings", "Reports", "Courses"].map((item) => (
                    <button
                      key={item}
                      onClick={() => {
                        setSearchQuery(item);
