...
const Header = memo(({
  ...
  const handleDateClick = useCallback((date) => {
    ...
    setShowCalendar(false);
    // Navigate to meetings page with selected date
    ...
    >
      <div className="h-16 px-4 lg:px-6">
        <div className="flex justify-between items-center h-full gap-4">
          ...
          <div className="flex items-center flex-shrink-0">
            {/* Desktop Logo */}
            <Link to="/dashboard" className="hidden md:flex items-center gap-3 hover:opacity-90 transition-opacity">
              <div className="w-10 h-10 bg-gradient-to-br from-blue-500 via-blue-600 to-blue-700 rounded-xl flex items-center justify-center shadow-lg shadow-blue-500/25">
                <Icon name="graduation-cap" className="text-white" size="text-lg" />
              </div>
            ...
            <Link to="/dashboard" className="md:hidden flex items-center gap-2">
              <div className="w-9 h-9 bg-gradient-to-br from-blue-500 via-blue-600 to-blue-700 rounded-xl flex items-center justify-center shadow-md">
                <Icon name="graduation-cap" className="text-white" size="text-sm" />
              </div>
              <span className="font-bold text-gray-900 dark:text-white">PMS</span>
            </Link>
          </div>
            ...
            <form onSubmit={handleSearch}>
              <div className="relative group">
                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                  <Icon name="magnifying-glass" className="text-gray-400 group-focus-within:text-blue-500 transition-colors" size="text-sm" />
                </div>
                <input
                  type="text"
                  value={searchQuery}
                  ...
                  className="w-full pl-10 pr-16 py-2.5 bg-gray-100 dark:bg-gray-800 rounded-xl border border-transparent focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:bg-white dark:focus:bg-gray-700 text-sm dark:text-white dark:placeholder-gray-400 transition-all"
                  aria-label="Search"
                />
                <div className="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none">
                  <kbd className="hidden sm:inline-flex items-center gap-1 px-2 py-1 text-xs font-medium bg-gray-200 dark:bg-gray-700 text-gray-500 dark:text-gray-400 rounded-md border border-gray-300 dark:border-gray-600">
          ...
          <div className="flex items-center gap-1 sm:gap-2">
            ...
            <div className="hidden md:flex items-center gap-1">
              ...
              <div className="relative" ref={quickAddRef}>
                ...
                {showQuickAdd && (
                  ...
                  >
                    <div 
                      className="w-60 bg-white dark:bg-gray-800 rounded-2xl shadow-xl shadow-gray-200/50 dark:shadow-gray-900/50 py-2 border border-gray-100 dark:border-gray-700 animate-slide-down"
                      role="menu"
                      aria-label="Quick add menu"
                    >
                    <div className="px-4 py-2.5 border-b border-gray-100 dark:border-gray-700">
                      <h3 className="text-sm font-semibold text-gray-900 dark:text-white flex items-center gap-2">
                        <Icon name="bolt" className="text-yellow-500" size="text-sm" />
                        Quick Actions
                      </h3>
                    </div>
                    <div className="py-1">
                      {quickAddActions.map((action, index) => (
                        ...
                        >
                          ...
                          >
                            <Icon name={action.icon} className={action.color} size="text-sm" />
                          </div>
              ...
              <button
                onClick={toggleTheme}
                className="p-2.5 text-gray-600 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-xl transition-all"
            ...
            <div className="relative" ref={notificationsRef}>
              ...
              {showNotifications && (
                ...
                >
                  <div 
                    className="w-80 sm:w-96 bg-white dark:bg-gray-800 rounded-2xl shadow-xl shadow-gray-200/50 dark:shadow-gray-900/50 py-2 border border-gray-100 dark:border-gray-700 animate-slide-down"
                    role="menu"
                  ...
                  <div className="px-4 py-3 border-b border-gray-100 dark:border-gray-700">
                    <div className="flex justify-between items-center">
                      <h3 className="font-semibold text-gray-900 dark:text-white flex items-center gap-2">
                        <Icon name="bell" className="text-blue-500" size="text-sm" />
                        Notifications
                      </h3>
                    ...
                    {notifications.slice(0, 5).map((notification) => (
                      ...
                      >
                        <div className="flex items-start gap-3">
                          ...
                          >
                            <Icon name={notification.icon} className={notification.color} size="text-sm" />
                          </div>
            ...
            <div className="relative" ref={userMenuRef}>
              ...
              >
                <div className="relative">
                  ...
                  <div className="absolute -bottom-0.5 -right-0.5 w-3.5 h-3.5 bg-green-500 border-2 border-white dark:border-gray-900 rounded-full" aria-label="Online"></div>
                </div>
              ...
              {showUserMenu && (
                ...
                >
                  <div 
                    className="w-72 bg-white dark:bg-gray-800 rounded-2xl shadow-xl shadow-gray-200/50 dark:shadow-gray-900/50 py-2 border border-gray-100 dark:border-gray-700 animate-slide-down"
                    role="menu"
                    aria-label="User menu"
                  >
                  {/* User Info */}
                  ...
                  <div className="py-2">
                    ...
                    >
                      <div className="w-8 h-8 rounded-lg bg-gray-100 dark:bg-gray-700 flex items-center justify-center mr-3 group-hover:bg-blue-100 dark:group-hover:bg-blue-900/40 transition-colors">
                        <Icon name="gauge-high" className="text-gray-500 dark:text-gray-400 group-hover:text-blue-600 dark:group-hover:text-blue-400" size="text-sm" />
                      </div>
                    ...
                    >
                      <div className="w-8 h-8 rounded-lg bg-gray-100 dark:bg-gray-700 flex items-center justify-center mr-3 group-hover:bg-blue-100 dark:group-hover:bg-blue-900/40 transition-colors">
                        <Icon name="user" className="text-gray-500 dark:text-gray-400 group-hover:text-blue-600 dark:group-hover:text-blue-400" size="text-sm" />
                      </div>
                    ...
                    >
                      <div className="w-8 h-8 rounded-lg bg-gray-100 dark:bg-gray-700 flex items-center justify-center mr-3 group-hover:bg-blue-100 dark:group-hover:bg-blue-900/40 transition-colors">
                        <Icon name="gear" className="text-gray-500 dark:text-gray-400 group-hover:text-blue-600 dark:group-hover:text-blue-400" size="text-sm" />
                      </div>
                    ...
                    {user?.role === "admin" && (
                      ...
                      >
                        <div className="w-8 h-8 rounded-lg bg-gray-100 dark:bg-gray-700 flex items-center justify-center mr-3 group-hover:bg-blue-100 dark:group-hover:bg-blue-900/40 transition-colors">
                          <Icon name="shield-halved" className="text-gray-500 dark:text-gray-400 group-hover:text-blue-600 dark:group-hover:text-blue-400" size="text-sm" />
                        </div>
                    ...
                    >
                      <div className="w-8 h-8 rounded-lg bg-red-50 dark:bg-red-900/30 flex items-center justify-center mr-3 group-hover:bg-red-100 dark:group-hover:bg-red-900/50 transition-colors">
                        <Icon name="right-from-bracket" className="text-red-500" size="text-sm" />
                      </div>
      ...
      {showSearch && (
        <div 
          ...
          className="bg-black/60 backdrop-blur-sm flex items-start justify-center pt-16 sm:pt-24 px-4"
          role="dialog"
          aria-modal="true"
          aria-labelledby="search-modal-title"
          onClick={(e) => e.target === e.currentTarget && setShowSearch(false)}
        >
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl w-full max-w-lg animate-slide-down border border-gray-100 dark:border-gray-700">
            <div className="p-4 sm:p-5">
              <div className="flex items-center justify-between mb-4">
                <h3 id="search-modal-title" className="font-semibold text-gray-900 dark:text-white flex items-center gap-2">
                  <Icon name="magnifying-glass" className="text-blue-500" size="text-sm" />
                  Search
                </h3>
                <button
                ...
                >
                  <Icon name="xmark" className="text-gray-500 dark:text-gray-400" size="text-lg" />
                </button>
              </div>
              <form onSubmit={handleSearch}>
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                    <Icon name="magnifying-glass" className="text-gray-400" size="text-sm" />
                  </div>
                  <input
                    type="text"
                    value={searchQuery}
              ...
              <div className="mt-5">
                ...
                <div className="flex flex-wrap gap-2">
                  {["Projects", "Students", "Meetings", "Reports", "Courses"].map(
                    (item) => (
                      <button
                        key={item}
                        onClick={() => {
