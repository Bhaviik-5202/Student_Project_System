...
const Footer = memo(() => {
  ...
  return (
    <footer
      className="bg-white dark:bg-gray-900 border-t border-gray-200 dark:border-gray-800 py-8 mt-auto"
      role="contentinfo"
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400 max-w-sm mb-4">
              A comprehensive platform for managing academic projects, fostering
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link
                  to="/dashboard"
                  className="text-sm text-gray-500 hover:text-blue-500 dark:text-gray-400 transition-colors"
                >
                  Dashboard
                </Link>
              </li>
        ...
        <div className="pt-8 border-t border-gray-100 dark:border-gray-800 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-xs text-gray-500 dark:text-gray-400">
            © {currentYear} Student Project Management System. Built with{" "}
            <i className="fas fa-heart text-red-500 mx-0.5"></i> for Academic
            Excellence.
          </p>
          <div className="flex items-center gap-6">
            <Link
              to="/privacy"
              className="text-xs text-gray-500 hover:text-blue-500 dark:text-gray-400 transition-colors"
            >
              Privacy Policy
            </Link>
            <Link
