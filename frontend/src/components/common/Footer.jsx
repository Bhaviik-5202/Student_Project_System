...
const FeatureBadge = memo(({ icon: Icon, text }) => (
  <div className="flex items-center gap-2 rounded-full bg-slate-100/80 dark:bg-slate-900/5 backdrop-blur-sm border border-slate-200/50 dark:border-white/5 px-3 py-1.5">
    <Icon size={14} className="text-indigo-500 dark:text-indigo-400" aria-hidden="true" />
        ...
        <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-3 px-4 sm:flex-row sm:px-6 lg:px-8">
          ...
          <div className="flex items-center gap-6">
            <span className="flex items-center gap-2 text-xs text-slate-500 dark:text-slate-400">
              <Sparkles size={12} className="text-indigo-500 dark:text-indigo-400" aria-hidden="true" />
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <div>
                <h2 className="text-xl font-bold text-slate-900 dark:text-white tracking-tight">
                  Student<span className="text-indigo-500 dark:text-indigo-400">.</span>Project
                </h2>
          ...
          <div className="md:col-span-4 space-y-4">
            ...
            <div className="rounded-2xl border border-slate-200 dark:border-white/10 bg-slate-50/80 dark:bg-white/5 backdrop-blur-sm p-4 space-y-3 transition-colors">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm font-medium text-emerald-600 dark:text-emerald-400">All Systems Go</span>
                </div>
              ...
              <div className="flex items-center gap-3 text-xs text-slate-600 dark:text-slate-400">
                <div className="flex items-center gap-1.5">
                  <CheckCircle size={12} className="text-indigo-500 dark:text-indigo-400" aria-hidden="true" />
                  <span>Active projects</span>
                  <span className="font-semibold text-slate-800 dark:text-white">1,247</span>
                </div>
                <div className="w-px h-4 bg-slate-200 dark:bg-white/10" aria-hidden="true" />
                <div className="flex items-center gap-1.5">
                  <Users size={12} className="text-indigo-500 dark:text-indigo-400" aria-hidden="true" />
                  <span>Students</span>
                  <span className="font-semibold text-slate-800 dark:text-white">3.2k</span>
                </div>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3 text-xs text-slate-500 dark:text-slate-400">
              <span className="flex items-center gap-1.5">
                <Heart size={12} className="text-rose-500 dark:text-rose-400 fill-rose-500 dark:fill-rose-400" aria-hidden="true" />
                Made with passion
              </span>
        ...
        <div className="mt-12 pt-6 border-t border-slate-200 dark:border-white/5 flex flex-col items-center justify-between gap-4 sm:flex-row">
          ...
          <div className="flex items-center gap-6 text-xs text-slate-500 dark:text-slate-400">
            <Link to="/privacy" className="hover:text-indigo-600 dark:hover:text-white transition-colors focus:text-indigo-600 dark:focus:text-white focus:outline-none focus:ring-2 focus:ring-indigo-500 rounded-md px-1">
              Privacy Policy
            </Link>
            <Link to="/terms" className="hover:text-indigo-600 dark:hover:text-white transition-colors focus:text-indigo-600 dark:focus:text-white focus:outline-none focus:ring-2 focus:ring-indigo-500 rounded-md px-1">
              Terms of Service
            </Link>
            <span>🌐 English</span>
          </div>
