...
const Footer = memo(() => {
  ...
  useEffect(() => {
    const metricsTimer = setInterval(() => {
      ...
      setActiveUsers((prev) =>
        Math.max(
          50,
          Math.min(300, prev + (Math.floor(Math.random() * 21) - 10)),
        ),
      );
      setStorageUsed((prev) =>
  ...
  return (
    <footer
      className="bg-white dark:bg-gray-900 border-t-2 border-gray-300 dark:border-gray-800 mt-8 shadow-lg"
      role="contentinfo"
    >
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center">
                  <div className="bg-white dark:bg-gray-800 w-12 h-12 rounded-full flex items-center justify-center shadow-sm mr-4">
                    <i
                      className="fas fa-user text-blue-600 dark:text-blue-400 text-lg"
                      aria-hidden="true"
                    ></i>
                  </div>
                  <div>
            ...
            <div className="bg-gradient-to-br from-gray-50 to-white dark:from-gray-800 dark:to-gray-900 border border-gray-200 dark:border-gray-700 rounded-xl p-5 shadow-sm">
              <div className="text-center mb-4">
                <div className="flex items-center justify-center mb-3">
                  <i
                    className="fas fa-clock text-gray-400 dark:text-gray-500 mr-2"
                    aria-hidden="true"
                  ></i>
                  <span className="text-sm font-medium text-gray-900 dark:text-white">
                    Current Time
          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="mb-4 md:mb-0">
              <div className="flex flex-wrap gap-4">
                ...
                >
                  <div className="w-8 h-8 rounded-lg flex items-center justify-center mr-2 bg-gray-100 dark:bg-gray-800">
                    <i
                      className="fas fa-file-alt text-sm"
                      aria-hidden="true"
                    ></i>
                  </div>
                  Documentation
                ...
                >
                  <div className="w-8 h-8 rounded-lg flex items-center justify-center mr-2 bg-gray-100 dark:bg-gray-800">
                    <i
                      className="fas fa-file-contract text-sm"
                      aria-hidden="true"
                    ></i>
                  </div>
                  Terms of Service
            ...
            <div className="text-center md:text-right">
              ...
              <div className="flex items-center justify-center md:justify-end text-xs gap-3">
                <span className="inline-flex items-center text-gray-500 dark:text-gray-400">
                  <i
                    className="fas fa-shield-alt mr-1 text-green-500"
                    aria-hidden="true"
                  ></i>
                ...
                <span className="inline-flex items-center text-gray-500 dark:text-gray-400">
                  <i
                    className="fas fa-database mr-1 text-blue-500"
                    aria-hidden="true"
                  ></i>
                ...
                <span className="inline-flex items-center text-gray-500 dark:text-gray-400">
                  <i
                    className="fas fa-rocket mr-1 text-purple-500"
                    aria-hidden="true"
                  ></i>
                  <span>v2.1.0</span>
                </span>
