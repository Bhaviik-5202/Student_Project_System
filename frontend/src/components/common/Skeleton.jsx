...
export const DashboardSkeleton = () => (
  <div className='space-y-6'>
    ...
    <div className='grid grid-cols-1 gap-6 lg:grid-cols-3'>
      <div className='min-h-[400px] rounded-2xl border border-slate-100 bg-white p-6 shadow-sm dark:border-slate-700/50 dark:bg-slate-800 lg:col-span-2'>
...
export const TableSkeleton = () => (
  <div className='overflow-hidden rounded-2xl border border-slate-100 bg-white shadow-sm dark:border-slate-700/50 dark:bg-slate-800'>
    ...
    <div className='p-0'>
      <div className='grid grid-cols-5 border-b border-slate-50 bg-slate-50/50 p-4 dark:border-slate-800 dark:bg-slate-900/50'>
        {[1, 2, 3, 4, 5].map((i) => (
